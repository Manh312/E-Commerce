...
namespace server.Migrations
{
    ...
    [Migration("20250607091418_FixBrandAndCategories")]
    partial class FixBrandAndCategories
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("server.Entities.ProductCategories", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("server.Entities.Product", b =>
                {
                    ...
                    b.HasOne("server.Entities.ProductCategories", "ProductCategories")
                        .WithMany()
            ...
            modelBuilder.Entity("server.Entities.ProductCategories", b =>
                {
                    b.HasOne("server.Entities.Image", "Image")
                        .WithOne("ProductCategories")
                        .HasForeignKey("server.Entities.ProductCategories", "ImageId")
                        .OnDelete(DeleteBehavior.SetNull);
